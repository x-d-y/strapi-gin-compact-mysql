...
func (r *Routers) NewTest1Hadler(c *gin.Context) {
	fmt.Println("this is newTest1Handler")
}

func (r *Routers) NewTest2Hadler(c *gin.Context) {
	fmt.Println("this is newTest2Handler")
}
